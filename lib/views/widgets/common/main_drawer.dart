      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            title: const Text('التقارير والأرباح', style: TextStyle(fontFamily: 'Cairo')),
            onTap: () {
          ...
          ListTile(
            ...
            title: const Text('إدارة العملات', style: TextStyle(fontFamily: 'Cairo')),
            onTap: () {
              Navigator.pop(context);
          ...
          ListTile(
            ...
            title: const Text('مصاريف الصيانة', style: TextStyle(fontFamily: 'Cairo')),
            onTap: () {
              Navigator.pop(context);
          ...
          ListTile(
            ...
            title: const Text('الإعدادات والنسخ الاحتياطي', style: TextStyle(fontFamily: 'Cairo')),
            onTap: () {
              Navigator.pop(context);
